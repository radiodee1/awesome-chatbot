...
* `do_make_db_tab_from_cornell_movie.py` Make db file or tab file from movie subtitles corpus. If you make a tab file, separate parts of the file with `do_split.py`.
