...
TEST_5="--mode=long --basename=test_s2s_general_d300_v15000_length15 --load-babi --lr=0.001 --dropout=0.5 --load-recurrent --units=300 --record-loss --multiplier=0.5 --length=15 --skip-unk --hide-unk"
